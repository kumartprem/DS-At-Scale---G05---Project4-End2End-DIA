...
# Check if the input wallet address is in the Gold table
if json.loads(result_etl)["test_val"] == 0:
    print(json.loads(result_etl)["message_to_user"])
...
displayHTML(json.loads(result_dash)["output_content"])
