...
GROUP='G05'   # CHANGE TO YOUR GROUP NAME format Gxx
...
spark.conf.set("spark.sql.shuffle.partitions", "12")  # Configure the size of shuffles the same as core count on your cluster
